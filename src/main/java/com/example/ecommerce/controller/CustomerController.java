...
public class CustomerController {
    ...
    public ResponseEntity<CartDto> addProductToCart(Authentication authentication,
    ...
    public ResponseEntity<Void> removeProductFromCart(Authentication authentication,
